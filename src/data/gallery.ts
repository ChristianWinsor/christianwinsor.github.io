...
export const galleryItems: GalleryItem[] = [
  ...
  { id: 'atl-wordmark', category: 'branding', title: 'Among the Letters Wordmark', description: 'Editorial wordmark and frame for Among the Letters.', src: '/amongthelettersbranding.png', alt: 'Among the Letters script wordmark in a framed treatment' },
  { id: 'atl-mark', category: 'branding', title: 'Among the Letters Mark', description: 'Circular brand mark for the literary publication.', src: '/atllogo.jpg', alt: 'Circular Among the Letters logo' },
  { id: 'atl-editorial', category: 'advertising', title: 'Among the Letters Editorial Imagery', description: 'Literary still life used to introduce the publication.', src: '/amongletters.png', alt: 'Open book, envelopes, fountain pen, and coffee on a wooden desk' },
